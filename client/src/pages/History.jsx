...
const History = () => {
  ...
  const fetchUserAttempts = async () => {
    setLoading(true)
    try {
      const response = await apiConnector("GET", quizEndpoints.GET_USER_ATTEMPTS, null, {
            ...
            <div className='w-full'>
              {attempt.length > 0 ? (
                ...
                <div className='text-center py-10'>
                  ...
                  <p className='text-gray-500 text-sm mt-2'>Take some quizzes to see your history here</p>
                </div>
              )}
            </div>
          </div>
